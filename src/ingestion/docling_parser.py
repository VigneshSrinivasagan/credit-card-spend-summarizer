...
def get_image_context(img_b64: str) -> str:
    ...
    Returns an empty string on failure, allowing fallback to a caption or placeholder..
    """
    print(f" Base 64 image received : {img_b64}")
    llm = ChatOpenAI(
...
def parse_document(file_path: str) -> list[dict]:
   ...
   for item in doc.iterate_items():
       ...
       # the OpenAI vision model can receive it directly during generation.
           ...
           if img_b64:
                description = get_image_context(img_b64)
